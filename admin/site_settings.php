		...
		<div class="card-body">
			<form action="" id="manage-settings">
				<div class="form-group">
					<label for="name" class="control-label">CAEN-VOOS</label>
				...
				<div class="form-group">
					<label for="about" class="control-label">Sobre content</label>
	...
	$('#manage-settings').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast('Informação salva com sucesso.','successo')
					setTimeout(function(){
						location.reload()
					},1000)
				}
