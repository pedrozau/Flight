<div class="container-fluid">
	...
	<form action="" id="book-flight">
		...
		<div class="form-group row" id="qty">
			<div class="col-md-3">
			<label for="" class="control-label">Pessoa/s</label>
			<input type="number" class="form-control text-right" min='1' value="1" id="count" max="<?php echo $_GET['max'] ?>">
			</div>
			<div class="col-md-2">
			<label for="" class="control-label">&nbsp;</label>
			<button class="btn btn-primary btn-block" type="button" id="go">Ir</button>
			</div>
			<div class="col-md-2">
			<label for="" class="control-label">&nbsp;</label>
			<button class="btn btn-secondary btn-block" type="button" data-dismiss="modal">Cancelar</button>
			</div>
		</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp ==1 ){
					...
					document.location = "http://localhost/Teodora/paymentFacture.php"
				}
			}
		})
	})
