            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Voos disponíveis</h3>
                            ...
                            <div class="card-body">
                                <form id="manage-filter"  action="index.php?page=flights" method="POST">
                                    <div class="row form-group">
                                        <div class="col-sm-3">
                                            <label for="" class="control-label">Saindo de</label>
                                        ...
                                        <div class="col-sm-3">
                                            <label for="" class="control-label">Indo para</label>
                                        ...
                                        <div class="col-sm-3">
                                            <label for="" class="control-label">Data de ida</label>
        	...
        	<div class="card">
        			...
        			<div class="col-lg-12">
						<div class="row">
							<div class="col-md-12 text-center">
								<h2><b><?php echo isset($trip) && $trip == 2 ? "Departure Searched Flight results..." : ( !isset($trip)? " Voos disponiveis " :"Searched Flight results...")  ?></b></h2>
							</div>
						</div>
						<hr class="divider">
				<?php 
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						 ...
						 <p><small>Companhia Aérea: <b><?php echo $row['airlines'] ?></b></small></p>
						 <p><small>Embarque: <b><?php echo date('h:i A',strtotime($row['departure_datetime'])) ?></b></small></p>
						 <p><small>Desembarque: <b><?php echo (date('M d,Y',strtotime($row['departure_datetime'])) == date('M d,Y',strtotime($row['arrival_datetime']))) ? date('h:i A',strtotime($row['arrival_datetime'])) : date('M d,Y h:i A',strtotime($row['arrival_datetime'])) ?></b></small></p>
						 <p>Assentos disponíveis : <b><h4><?php echo $row['seats'] - $booked ?></h4></b></p>
					</div>
					<div class="col-md-3 text-center align-self-end-sm">
						<h4 class="text-right"><b><?php echo number_format($row['price'],2) ?></b></h4>
						<button class="btn-outline-primary  btn  mb-4 book_flight" type="button" data-id="<?php echo $row['id'] ?>"  data-name="<?php echo $aname[$row['departure_airport_id']].' - '.$aname[$row['arrival_airport_id']] ?>" data-max="<?php echo $row['seats'] - $booked ?>">Marcar já</button>
					</div>
				</div>
				...
				<?php if(isset($trip) && $trip ==2): ?>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<h2><b><?php echo isset($trip) && $trip == 2 ? "Arrival Searched Flight results..." : ( !isset($trip)? " Voos disponiveis " :"Searched Flight results...")  ?></b></h2>
						</div>
					</div>
						<hr class="divider">
				<?php 
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						 <p><b><?php echo $aname[$row['departure_airport_id']].' - '.$aname[$row['arrival_airport_id']] ?></b></p>
						 <p><small>Companhia Aérea: <b><?php echo $row['airlines'] ?></b></small></p>
						 <p><small>Partida: <b><?php echo date('h:i A',strtotime($row['departure_datetime'])) ?></b></small></p>
						 <p><small>Aterragem: <b><?php echo (date('M d,Y',strtotime($row['departure_datetime'])) == date('M d,Y',strtotime($row['arrival_datetime']))) ? date('h:i A',strtotime($row['arrival_datetime'])) : date('M d,Y h:i A',strtotime($row['arrival_datetime'])) ?></b></small></p>
						 <p>Assentos disponíveis : <b><h4><?php echo $row['seats'] - $booked ?></h4></b></p>
					</div>
					<div class="col-md-3 text-center align-self-end-sm">
						<h4 class="text-right"><b><?php echo number_format($row['price'],2) ?></b></h4>
				...
				<?php else: ?>
					<div class="row align-items-center">
						<h5 class="text-center"><b>Sem resultados.</b></h5>
					</div>
				<?php endif; ?>
				<?php endif; ?>
				</div>
